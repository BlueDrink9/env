...
let s:nmappings = {
      ...
      \ g:IDE_mappings.debugStart : 'workbench.action.debug.run',
      \ g:IDE_mappings.debugRestart : 'workbench.action.debug.restart',
      \ g:IDE_mappings.debugReset : 'workbench.action.debug.stop',
      \ g:IDE_mappings.debugContinue : 'workbench.action.debug.continue',
      \ g:IDE_mappings.debugPause : 'workbench.action.debug.pause',
      \ g:IDE_mappings.debugStepOver : 'workbench.action.debug.stepOver',
      \ g:IDE_mappings.debugStepInto : 'workbench.action.debug.stepInto',
      \ g:IDE_mappings.debugStepOut : 'workbench.action.debug.stepOut',
      \ g:IDE_mappings.debugHover : 'workbench.action.debug.showDebugHover',
      \ g:IDE_mappings.setBreakpoint : 'editor.debug.action.toggleInlineBreakpoint',
      \ g:IDE_mappings.clearBreakpoints : 'editor.clearBreakpoints',
