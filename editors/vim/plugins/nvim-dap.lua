...
local dap_nbufmaps = {
   [maps.debug_file] = 'continue()',
   [maps.debug_reset] = 'terminate()',
   [maps.debug_continue] = 'continue()',
   [maps.debug_restart] = 'run_last()',
   [maps.debug_step_over] = 'step_over()',
   [maps.debug_step_into] = 'step_into()',
   [maps.debug_step_out] = 'step_out()',
   [maps.debug_step_back] = 'step_back()',
   [maps.debug_run_to_here] = 'run_to_cursor()',
   [maps.debug_inspect] = 'repl.toggle()',
   [maps.debug_frame_up] = 'up()',
   [maps.debug_frame_down] = 'down()',
   [maps.set_breakpoint] = 'toggle_breakpoint()',
   [maps.set_breakpoint_conditional] = "set_breakpoint(vim.fn.input('Breakpoint condition: ')",
   [maps.breakpoint_list] = 'list_breakpoints()',
   -- [debug_show_output] = '',
   -- [debug_hover] = '',
}
